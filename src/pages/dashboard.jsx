...
const skills = [
  ...
  { name: "Communication", color: "warning" },
  { name: "Critical Thinking", color: "primary" },
  { name: "Adaptability", color: "secondary" },
  { name: "Time Management", color: "success" },
  { name: "Patience", color: "warning" },
];
  ...
  return (
    <>
      ...
      <div className="flex justify-center">
        <hr className="border-y-1 border-slate-950 w-11/12 my-4" />
      </div>
      <p className="text-center text-2xl font-bold">Skills</p>
      <div className="flex max-sm:flex-col justify-evenly sm:items-start items-center w-full my-5">
        ...
        <div className="sm:flex sm:justify-center sm:items-center sm:h-80 max-sm:w-2/3 max-sm:mx-auto max-sm:my-3">
          <hr className="sm:py-24 max-sm:border-y-1 sm:border-x-1 border-slate-950" />
        </div>
        <div className="flex flex-col flex-1 max-sm:mx-5 sm:mx-2 max-w-xs lg:max-w-md">
